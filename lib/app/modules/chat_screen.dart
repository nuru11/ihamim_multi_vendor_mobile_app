...
void dispose() {
  ...
  _messageController.setCurrentChatUser(-1);
  super.dispose();
}
    ...
    children: [
      Expanded(
        child: Obx(() {
          ...
          if (_messageController.isLoadingConversation.value) {
...
//   // Emit chat_opened AFTER socket has been initialized/connected
//   Future.delayed(const Duration(milliseconds: 200), () {
//     _messageController.socket?.emit("chat_opened", {
...
//   WidgetsBinding.instance.addPostFrameCallback((_) async {
//     await _messageController.loadConversation(widget.currentUserId, widget.otherUserId);
//     await _messageController.markAsRead(widget.currentUserId, widget.otherUserId);
//     _scrollToBottom();
//   });
...
//   }
//   _messageController.isOtherUserTyping.value = false; // reset typing
//   _messageController.setCurrentChatUser(0);
//   super.dispose();
// }
...
//             msg.fileUrl!.endsWith(".jpg") || msg.fileUrl!.endsWith(".png")
//                 ? Image.network(msg.fileUrl!, height: 150) // preview images
//                 : InkWell(
...
//       allowMultiple: false,
//       type: FileType.any, // Or use FileType.image / video / custom
//     );
...
//       // 👇 send file via controller
//       _messageController.sendFile(
//         widget.currentUserId,
//         widget.otherUserId,
//         file,
//         fileName,
